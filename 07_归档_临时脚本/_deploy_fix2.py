...
# Upload engine.py
with open(r'C:\Users\Administrator\Documents\OiioiiPool\core\engine.py', 'r', encoding='utf-8') as f:
    engine_code = f.read()
...
with sftp.open('/home/ubuntu/oiioii/core/engine.py', 'w') as f:
    f.write(engine_code)
print("Uploaded engine.py")
sftp.close()

# Restart service
stdin, stdout, stderr = ssh.exec_command('sudo systemctl restart oiioii')
print("Restarting oiioii...")
time.sleep(5)
