...
# Anti-abuse: max registrations per IP in 24 hours
MAX_REGISTER_PER_IP = int(os.environ.get("AIFORGE_MAX_REG_PER_IP", "3"))
...
LLM_API_URL = os.environ.get("AIFORGE_LLM_URL", "https://token.sensenova.cn/v1/chat/completions")
LLM_API_KEY = os.environ.get("AIFORGE_LLM_KEY", "sk-nwbv2S8L7xszwt7KjFKAIxoFA9v4ZJfC")
LLM_MODEL = os.environ.get("AIFORGE_LLM_MODEL", "deepseek-v4-flash")
