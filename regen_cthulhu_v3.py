#!/usr/bin/env python3
"""Regenerate project #26 videos WITHOUT reference images (Gemini Omni doesn't support them well)"""
import requests
import json
import time
import sys
...
def main():
    print("=== Regenerating Project #26 videos (no ref images) ===")
    ...
    if video_results:
        ...
        print(f"  First pass: {done} done, {failed} failed")
